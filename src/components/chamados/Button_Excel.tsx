...
export function ExportaExcelChamadosButton({
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            if (chamadosComOS.length > 0) renderSecao("CHAMADOS COM OS's", chamadosComOS);
    ...
    return (
        <button
            ...
            className={`group cursor-pointer rounded-md bg-gradient-to-br from-green-600 to-green-700 p-3 shadow-md shadow-black transition-all duration-300 hover:scale-115 hover:shadow-xl hover:shadow-black active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 ${className}`}
        >
            {isExporting ? (
